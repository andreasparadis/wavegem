function [outData, FR, PSDs]=PlotFASToutput(FASTfiles,FASTfilesDesc,ReferenceFile,Channels,ShowLegend,CustomHdr,PlotPSDs,OnePlot)
%..........................................................................
...
% ------------------------------------------------------------
if PlotPSDs
    [FR, PSDs] = plotPSDData( outData, FASTfilesDesc, Markers, LineColors, ...
                        columnTitles{ReferenceFile}([TimeIndex Channels]), ...
                        columnUnits{ReferenceFile}([TimeIndex Channels]), titleText, ...
...
%%
function [f1, PSDs] = plotPSDData( outData, FASTfilesDesc, Markers, LineColors, ...
                    RefColumnTitles, RefColumnUnits, titleText, ShowLegend, LineWidthConst, FntSz )
numCols  = size(outData{1,2},2) ;
numFiles = size(outData,1);
Nfft = floor(length(outData{1,2}(:,1))/2)
PSDs = zeros(Nfft, numCols);
...
%          xlim([0.001,0.2]);
%          ylim([0, max(real(sqrt(Sf1(2:end))))]);
