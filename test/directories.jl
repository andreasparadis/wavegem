function paths(pdir, run_id, phi_id, prb_id, flong)
    ...
    OW3Dinp::String = OW3Dpath * runstr * "/$(phi_id)/"
    Dpath::String = libpath * "/$(pdir)/$(case_id)/$(run_id)/Decomposition/"
    DecFigs::String = Dpath * "Figures/"
    DecEvs::String = Dpath * "events/"
    ...
    return runstr, rundir, phipath, OW3Drdir, OW3Dinp, Dpath, DecEvs, DecFigs, postOFpath, postOW3Dpath
end
